...
#litros, que custam R$ 80,00 ou em galões
#de 3,6 litros, que custam R$ 25,00. 
#Informe ao usuário as quantidades de tinta
#a serem compradas e os respectivos preços em 3
#situações:
#
#a. comprar apenas latas de 18 litros; 
#b. comprar apenas galões de 3,6 litros; 
#c. misturar latas e galões, de forma que o
#preço seja o menor. Acrescente 10% de folga e
#sempre arredonde os valores para cima,
